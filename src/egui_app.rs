...
const PREVIEW_WHEEL_ZOOM_MULTIPLIER: f32 = 4.0;
...
impl LatentSlateApp {
    pub fn new(cc: &eframe::CreationContext<'_>) -> Self {
        ...
        Self {
            ...
            providers_modal_was_open: false,
            selected_provider: None,
            engine_connection_draft: None,
            engine_inspector_tab: EngineInspectorTab::default(),
