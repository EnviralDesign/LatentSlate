...
use crate::state::{
    Asset, AssetKind, AssetLabAuthoring, AssetLabNode, BatchSettings, ClipBridgeLink,
    ClipImageMode, ClipTimeMode, ClipTransform, GenerativeConfig, InputValue, Project,
    ProjectProviderScope, ProjectSettings, ProviderEntry, ProviderOutputType, SelectionState,
    TrackType,
};
...
pub struct GenerativeConfigPatch {
    ...
    #[serde(default)]
    pub lab_authoring: Option<AssetLabAuthoring>,
}
