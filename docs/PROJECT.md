...
- Engine-authored model variants automatically become ordinary schema-driven LatentSlate providers after catalog refresh; current local proofs include Klein 4B stored-FP8 T2I and one-reference I2I through the public jobs API.
...
- H3/LTX and native Wan target-hardware output acceptance still needs the planned hands-on pass even though their Engine repository/artifact contracts now validate fail-closed.
