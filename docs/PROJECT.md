...
- Timeline and Asset Lab continuation actions seed new I2I/I2V/edit steps from the referenced generative settings while replacing the media reference.
...
| Area | Decision |
|---|---|
| Project identity | Public name, executable, package, automation env vars, and repo-local runtime roots use `LatentSlate`; maker identity is Enviral Design. |
