...
- Provider workflow paths are saved relative to known resource roots when possible; new Provider Builder manifests are saved under `LatentSlateData/provider-manifests/`.
