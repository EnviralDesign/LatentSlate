...
- LatentSlate Engine catalog discovery with stable tool UUIDs, offline catalog readability, source/state badges, and read-only Engine observability in AI Providers.
